...
var StoryEditor = function (_Component) {
  ...
  function StoryEditor(props) {
    ...
    var initialText = id ? '' : (0, _i18n2.default)('editor.initial_text');

    _this.state = {
      body: (0, _nlp2.default)(initialText),
      title: (0, _i18n2.default)('editor.initial_title'),
      text: initialText,
      mode: 'vr',
      _id: id,
      loading: !!id
  ...
  _createClass(StoryEditor, [{
    ...
    value: function onSave() {
      ...
      if (!title.length) {
        window.alert((0, _i18n2.default)('editor.title_missing'));
        return;
      }

      if (this.state._id) {
        (0, _datalayer.updateStory)(this.state).then(function (story) {
          return _this2.setState(Object.assign({}, _this2.state, { _id: story._id }));
        });
      } else {
        (0, _datalayer.createStory)(this.state).then(function (story) {
          _this2.setState(Object.assign({}, _this2.state, { _id: story._id }));
          (0, _preactRouter.route)('/stories/' + story._id);
        }).then(function () {
          return console.log(_this2.state, 'state');
        });
      }
    }
  }, {
    ...
    value: function onShare() {
      ...
      window.open(_config.assetsHost + '/s/' + _id + '.html', '_blank');
    }
  }, {
    key: 'render',
    value: function render(_ref, _ref2) {
      ...
      return (0, _preact.h)(
        ...
        !loading ? (0, _preact.h)(
          'div',
          null,
          (0, _preact.h)(_Editor2.default, { value: text, onInput: this.onEditorChange.bind(this) })
        ) : null,
        (0, _preact.h)(_Previewer2.default, { body: body, mode: mode }),
...
var Header = function Header() {
  return (0, _preact.h)(
    ...
    (0, _preact.h)(
      ...
      (0, _preact.h)(
        'a',
        _extends({ href: '#', activeColor: '#ccc' }, styles.backbutton),
        '\u2039'
      )
    )
  );
...
var Toolbar = function Toolbar(_ref3) {
  ...
  return (0, _preact.h)(
    ...
    (0, _preact.h)(
      'div',
      null,
      (0, _preact.h)('input', _extends({}, styles.title, { type: 'text', placeholder: (0, _i18n2.default)('editor.title'),
        value: title, onChange: onChangeTitle, required: true })),
      (0, _preact.h)(
        'button',
        _extends({}, styles.button, { onClick: onSave }),
        (0, _i18n2.default)('editor.save')
      )
    ),
    (0, _preact.h)(
      'div',
      ...
      (0, _preact.h)(
        'button',
        _extends({}, styles.button, { onClick: onPreview }),
        (0, _i18n2.default)('editor.preview')
      )
    )
  );
};
...
var styles = {
  ...
  toolbarContainer: (0, _glamor.style)({
    backgroundColor: '#eee',
    display: 'flex',
    padding: '0 10px',
