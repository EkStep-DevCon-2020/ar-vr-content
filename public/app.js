...
exports.fetchSession = exports.user = undefined;

var _wildemitter = __webpack_require__(44);
...
var fetchSession = exports.fetchSession = function fetchSession() {
  return fetch('/me', { credentials: 'same-origin' }).then(function (res) {
    return res.json();
  }).then(function (data) {
    exports.user = user = data.user;
  }).catch(function (err) {
...
exports.loadTranslations = exports.getLocale = exports.setLocale = undefined;
...
var setLocale = exports.setLocale = function setLocale(locale) {
  ...
  return loadTranslations().then(function () {
    return _guri2.default.emit('renderApp');
  });
};

var getLocale = exports.getLocale = function getLocale() {
  return (localStorage.getItem('locale') || navigator.locale || 'en').split('-')[0];
};
...
var loadTranslations = exports.loadTranslations = function loadTranslations() {
  try {
    ...
    localStorage.setItem('locale', locale);
    var lang = locales[locale.split('-')[0]] || 'en';
...
var fetchTranslations = function fetchTranslations(locale) {
  return fetch('/translations/' + locale + '.json').then(function (res) {
    return res.json();
  }).then(function (json) {
    translations = json;
  });
...
var _dangerousStyleValue = __webpack_require__(23);
...
var _SplitPoint = __webpack_require__(14);

var _SplitPoint2 = _interopRequireDefault(_SplitPoint);
    ...
    value: function render(props, _ref) {
      ...
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          ...
          null,
          (0, _preact.h)(_SplitPoint2.default, { key: 0, path: '/', load: function load() {
              return __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 47));
            } }),
          (0, _preact.h)(_SplitPoint2.default, { key: 1, path: '/guide', load: function load() {
              return __webpack_require__.e/* import() */(2).then(__webpack_require__.bind(null, 46));
            } }),
          (0, _preact.h)(_SplitPoint2.default, { key: 2, path: '/login', load: function load() {
              return __webpack_require__.e/* import() */(4).then(__webpack_require__.bind(null, 48));
            } }),
          (0, _preact.h)(_SplitPoint2.default, { key: 3, path: '/stories', load: function load() {
              return __webpack_require__.e/* import() */(3).then(__webpack_require__.bind(null, 50));
            } }),
          (0, _preact.h)(_SplitPoint2.default, { key: 4, path: '/stories/:id', load: function load() {
...
var _clean = __webpack_require__(24);
...
var SplitPoint = function (_Component) {
  _inherits(SplitPoint, _Component);

  function SplitPoint() {
    _classCallCheck(this, SplitPoint);

    return _possibleConstructorReturn(this, (SplitPoint.__proto__ || Object.getPrototypeOf(SplitPoint)).apply(this, arguments));
  }

  _createClass(SplitPoint, [{
    key: 'componentWillMount',
    value: function componentWillMount() {
      this.fetchComponent();
    }
    ...
    key: 'fetchComponent',
    value: function fetchComponent() {
      var cb = this.linkState('child');
      var r = this.props.load();
    ...
    value: function render(props, _ref) {
      ...
      return child ? (0, _preact.h)(child.default, props) : (0, _preact.h)('div', { 'class': 'loader' });
    }
  }]);
...
var _CSSProperty = __webpack_require__(22);
...
var _crossFade = __webpack_require__(30);
...
var _flexboxOld = __webpack_require__(34);

var _flexboxOld2 = _interopRequireDefault(_flexboxOld);

var _gradient = __webpack_require__(35);

var _gradient2 = _interopRequireDefault(_gradient);

var _imageSet = __webpack_require__(36);
...
var _sizing = __webpack_require__(38);
...
/* harmony default export */ exports["default"] = hyphenateStyleName;
...
var _capitalizeString = __webpack_require__(8);
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
/* harmony export (immutable) */ exports["Headers"] = Headers;
/* harmony export (immutable) */ exports["Request"] = Request;
/* harmony export (immutable) */ exports["Response"] = Response;
/* harmony export (binding) */ __webpack_require__.d(exports, "DOMException", function() { return DOMException; });
...
_guri2.default.on('renderApp', function () {
  return (0, _preact.render)((0, _preact.h)(_App2.default, null), document.getElementById('root'), document.getElementById('root').firstChild);
});
(0, _runtime.install)();

// Load translations and session info
Promise.all([(0, _i18n.loadTranslations)(), (0, _guri.fetchSession)()]).then(function () {
  return _guri2.default.emit('renderApp');
});
